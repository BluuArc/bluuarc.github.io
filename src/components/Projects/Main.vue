              ...
              <v-layout row wrap v-if="userData">
                ...
                <v-flex md9 xs12>
                  <v-card-text class="text-xs-center pb-0">
                    ...
                    <p class="mb-2">Contributed to at least <b>{{ projectData.overall.count.total }} public projects</b>, owning {{ projectData.overall.count.mine }} of them.</p>
                    <p class="mb-2">{{ projectData.user.followers }} follower(s) and following {{ projectData.user.following }} user(s)</p>
                    <p class="mb-2">
                      <span>User information last updated</span>
                      <date-text :top="true" :date="userData.updated_at"/>
                    </p>
                    <p class="mb-2" v-if="userData.last_active">
                      <span>Last Active on GitHub</span>
                      <date-text :top="true" :date="userData.last_active"/>
                    </p>
                  </v-card-text>
                </v-flex>
              </v-layout>
